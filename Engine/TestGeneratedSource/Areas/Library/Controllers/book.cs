...
/// <summary>
    ...
    /// book
    /// </summary>
    public class book :EBaseAppController<book,CommonParameter>
    {  private bookService _bookservice{get;set;} 

public book(bookService _bookservice){ 

      DefaultSaveName = "bookSave";
            DefaultDataTableName = "bookDataTable";this._bookservice=_bookservice; 
 }
